...
function safeDiskIcon(path) {
	if(!path || path.indexOf("file:") == 0 || path.charAt(0) == "/" || path.indexOf("disk.tiff") != -1)
		return "./images/defaultHD.png";
	return path;
}
...
TallDiskObject.prototype.updateWithData = function(data){
	...
	this.icon.src = safeDiskIcon(data[5]);
}
